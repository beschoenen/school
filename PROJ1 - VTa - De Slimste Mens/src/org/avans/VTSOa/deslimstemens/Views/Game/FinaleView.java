...
import org.avans.VTSOa.deslimstemens.Controllers.Game.FinaleController;
 ...
 */
public class FinaleView extends SceneView {
	...
	private FinaleController controller;

	public FinaleView(FinaleController controller) {
	...
	public void setQuestion(Question question) {
		...
		question.getAnswers().forEach(answer -> {
			OpenAnswerControl answerControl = new OpenAnswerControl(answer.getAnswer(), "-30");
