...
public class AlbumList extends ArrayAdapter<String> {

    private final Activity context;
    private final String[] web;
    private final String[] imageId;

    public AlbumList(Activity context, String[] web, String[] imageId) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        //Set image
        ImageView imageView = (ImageView) rowView.findViewById(R.id.AlbumImage);
