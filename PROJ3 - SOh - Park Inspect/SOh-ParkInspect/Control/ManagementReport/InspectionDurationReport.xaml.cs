...
{
    /// <summary>
    ///     Interaction logic for InspectionDurationReport.xaml
    /// </summary>
    public partial class InspectionDurationReport : UserControl
    {
        public InspectionDurationReport()
        {
            InitializeComponent();
            var vm = (InspectionDurationViewModel) DataContext;
