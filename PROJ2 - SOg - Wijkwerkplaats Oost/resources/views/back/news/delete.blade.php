...
@section('title', 'Verwijder nieuwsbericht')
...
@section('content')
    <form method="POST" action="{{ $url }}">
        ...
        <div class="row">
            <div class="col-md-12">
                <span class="delete-notify">Weet u zeker dat u dit nieuwsbericht wilt verwijderen?</span>
            </div>
        </div>
        <br>
        <div class="row">
...
@endsection
@section('tooltip')
    $("#tooltip").attr("data-original-title", "Hier kun je een nieuwsartikel verwijderen. Als je zeker weet dat je dit nieuwsartikel wil verwijderen klik dan op 'Verwijder'.");
@endsection