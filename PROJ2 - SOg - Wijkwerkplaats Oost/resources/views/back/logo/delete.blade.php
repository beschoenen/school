...
@section('content')
    <form method="POST" action="{{ $url }}">
        ...
        <div class="row">
            <div class="col-md-12">
                <span class="delete-notify">Weet u zeker dat u dit logo wilt verwijderen?</span>
            </div>
        </div>
        <div class="row">
...
@endsection
@section('tooltip')
    $("#tooltip").attr("data-original-title", "Hier kun je een logo verwijderen. Als je zeker weet dat je deze logo wil verwijderen klik dan op 'Verwijder'.");
@endsection
