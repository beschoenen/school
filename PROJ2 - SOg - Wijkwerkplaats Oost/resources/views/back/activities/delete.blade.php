...
@section('title', 'Activiteit verwijderen')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input id="section" name="section" type="text" class="form-control" value="{{ $activity->section }}" readonly>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <p>Weet u zeker dat u deze activiteit wilt verwijderen?</p>
            </div>
        </div>
        <div class="row">
